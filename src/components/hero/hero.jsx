...
const Hero = () => {
  return (
    <div className={styles.wrap}>
      <p className={styles.wrap__intro}>
        All in one learning management system
      </p>
      <h1 className={styles.wrap__title}>
        Manage your Teaching and Learning activities all in one place
      </h1>
      <p className={styles.wrap__text}>
        DigiPhront is a product designed to meet the technological needs of
        schools thus providing an easy process of learning and management
        activities. We promote smarter, bigger and effective school clans.
      </p>
