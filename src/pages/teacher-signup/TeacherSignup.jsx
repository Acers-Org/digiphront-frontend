                        ...
                        <form action="" className=' form w-75'>
                            ...
                            <div className='d-flex justify-content-between'>
                                <div className="row w-50">
                                    ...
                                    <select className="form-select" aria-label="Default select example" id="subject" required>                                        
                                          <option value=""  disabled selected hidden> English</option>
                                          <option value="english">English</option>
                                          <option value="maths">Mathematics</option>
                                          <option value="agricultultural Science">Agricultultural Science</option>
                                ...
                                <select className="form-select" aria-label="Default select example" id="age" required>
                                              <option value=""  disabled selected hidden> 24 </option>
