        ...
        <div className="row py-3">
              ...
              <div className="col-lg-12 col-md-12 col-sm-12 ">
                <div className="col-lg-6 col-sm-12 total-improvement">
                  ...
                  <div className="graph">
                    ...
                    <ul className="mt-5">
                      <li>
                        <i className="fa fa-circle ict" aria-hidden="true"></i>{" "}
                        Ict
                      </li>
                      <li>
                        <i className="fa fa-circle eng" aria-hidden="true"></i>{" "}
                        English
                      </li>
                      <li>
                        <i
                          className="fa fa-circle maths"
                          aria-hidden="true"
                        ></i>{" "}
                        Mathematics
                      </li>
                      <li>
                        <i className="fa fa-circle arts" aria-hidden="true"></i>{" "}
                        Arts
                      </li>
                      <li>
                        <i
                          className="fa fa-circle civic"
                          aria-hidden="true"
                        ></i>{" "}
                        Civic
                      </li>
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 feed-box">
                  <div className="col-lg-6 col-sm-12 feed">
                    <h3 className="text-capitalize feed-header">
                      important feed
                    </h3>
                    <div className="feed-content">
                      <h4 className="feed-content-header">
                        {" "}
                        <i className="fa fa-circle" aria-hidden="true"></i>{" "}
                        Introduction to Javascript{" "}
                      </h4>
                      <p className="feed-content-text">
                        {" "}
                        Don't forget to download Vscode{" "}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="aside col-lg-5 col-md-12 col-sm-12">
            <div className="d-flex search-box-group">
              ...
              <i
                className="fa fa-bell mt-4 mx-3 text-danger"
                aria-hidden="true"
              >
                {" "}
              </i>
